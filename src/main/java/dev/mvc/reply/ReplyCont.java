...
public class ReplyCont {
  ...
  public ModelAndView list(HttpSession session) {
    ...
    if (adminProc.isAdmin(session)) {
      List<ReplyMemberVO> list = replyProc.list_member_join();  // member id Join
...
//  }
  ...
  /**
   * 패스워드 체크& 댓글삭제
   * http://localhost:9090/resort/reply/delete.do?replyno=16&passwd='a084'
  ...
  /**
   * 더보기 버튼 페이징 목록
   * http://localhost:9090/resort/reply/list_by_contentsno_join_add.do?contentsno=16&replyPage=1
