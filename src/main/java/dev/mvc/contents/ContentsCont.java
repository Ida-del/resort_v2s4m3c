...
public class ContentsCont {
  ...
  public ModelAndView read(int contentsno) {
    ...
    // mav.setViewName("/contents/read_img_attachfile_reply_add"); // /webapp/contents/read_img_attachfile_reply.jsp    
    mav.setViewName("/contents/read_img_attachfile_reply_add_pg"); // /webapp/contents/read_img_attachfile_reply.jsp    
    return mav;
  }
...
//  }
  ...
  */
  ...
  public ModelAndView reply(int cateno, int contentsno, ContentsVO contentsVO) {
    ModelAndView mav = new ModelAndView();
    System.out.println("답변 대상: " + contentsno);
    
    CateVO cateVO = this.cateProc.read(cateno);
    mav.addObject("cateVO", cateVO);
    System.out.println("카데고리 번호: "+cateno);
  ...
  public ModelAndView reply(HttpServletRequest request, ContentsVO contentsVO) {
    ...
    System.out.println("memberno: " + contentsVO.getMemberno());
